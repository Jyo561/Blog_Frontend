...
function SideMenu() {
  return (
    <div class="flex h-screen w-16 flex-col justify-between border-e z-100 fixed sideMenu mx-3">
  <div>
  ...
  <div class="sticky inset-x-0 bottom-0 border-t border-gray-100 p-2">
    <form action="#">
      ...
      >
        ...
        <span
          class="invisible absolute start-full top-1/2 ms-4 -translate-y-1/2 rounded px-2 py-1.5 text-xs font-medium text-white group-hover:visible"
        >
          Logout
        </span>
      </button>
